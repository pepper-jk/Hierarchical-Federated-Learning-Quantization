...
if __name__ == '__main__':
    ...
    clip = args.clip_max_per_sample_grad_norm
    ...
    exporter = output.data_exporter(dataset, model, epochs, learning_rate, iid, unequal, frac, local_ep, local_bs, num_clusters,
                                    appendage=appendage, clip=clip, sigma_local=sigma_local, sigma_global=sigma_global,
